              ...
              <form onSubmit={handleRecoverSession} className="space-y-6">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-white font-['Space_Mono'] text-lg text-[#06080c] tracking-widest px-4 py-3 border-2 border-[#06080c] shadow-[2px_2px_0px_#06080c] focus:outline-none focus:shadow-[4px_4px_0px_#06080c] transition-shadow uppercase placeholder:text-[#76777b] placeholder:font-['JetBrains_Mono'] placeholder:text-sm placeholder:tracking-normal"
                  />
                </div>
                {recoverError && (
                  <div className="bg-[#ffdad6] border-2 border-[#ba1a1a] p-3 text-[#93000a] font-['JetBrains_Mono'] text-xs font-bold">
                    {recoverError}
                  </div>
                )}
                <button
            ...
            <div className="bg-white border-2 border-[#06080c] p-6 shadow-[6px_6px_0px_#06080c] flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-['JetBrains_Mono'] text-[10px] uppercase tracking-widest text-[#06080c] bg-[#edeef0] px-2 py-0.5 border border-[#06080c] font-bold">
                    LIVE HOST DECK
                  </span>
                </div>
              ...
              <div className="flex items-center gap-3 bg-[#f8f9fb] border-2 border-[#06080c] p-3 shadow-[2px_2px_0px_#06080c]">
                ...
                <button
                  ...
                  className="bg-[#06080c] text-white px-3 py-2 border border-[#06080c] font-['JetBrains_Mono'] text-xs uppercase hover:bg-[#1e2024] active:translate-x-0.5 active:translate-y-0.5 transition-all cursor-pointer font-bold flex items-center gap-1"
                >
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white border-2 border-[#06080c] p-6 shadow-[4px_4px_0px_#06080c] space-y-4">
                  ...
                  {isAutoAssign ? (
                    <button
                      ...
                      className="w-full bg-[#06080c] text-white font-['Space_Mono'] text-xs uppercase tracking-wider py-3 border-2 border-[#06080c] shadow-[2px_2px_0px_#76777b] hover:bg-[#1e2024] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all flex items-center justify-center gap-2 cursor-pointer font-bold disabled:opacity-50"
                    >
                ...
                <div className="bg-white border-2 border-[#06080c] p-6 shadow-[4px_4px_0px_#06080c] space-y-4">
                  <div className="flex items-center justify-between border-b-2 border-[#06080c] pb-3">
                    ...
                    <span className="font-['JetBrains_Mono'] text-xs font-bold bg-[#edeef0] px-2 py-0.5 border border-[#06080c]">
                  ...
                  {participants.length === 0 ? (
                    <div className="text-center py-6 border-2 border-dashed border-[#06080c] bg-[#f8f9fb]">
                      ...
                      <p className="font-['JetBrains_Mono'] text-xs text-[#45474b] mt-1">
              ...
              <div className="lg:col-span-2 space-y-6">
                <div className="bg-white border-2 border-[#06080c] p-6 shadow-[6px_6px_0px_#06080c] space-y-6">
                  <div className="border-b-2 border-[#06080c] pb-4 flex items-center justify-between">
                    ...
                    <span className="font-['JetBrains_Mono'] text-xs font-bold bg-[#edeef0] border border-[#06080c] px-3 py-1">
                      {photos.length} ITEMS
                    </span>
                  </div>
