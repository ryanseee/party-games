    ...
    <Layout title="Join Session">
      <div className="w-full max-w-xl mx-auto py-4 sm:py-8">
        ...
        <div className="mb-6">
          <Link
            to="/"
            className="inline-flex items-center gap-2 font-['Space_Mono',_monospace] text-xs text-[#06080c] uppercase tracking-wider hover:bg-[#edeef0] px-3 py-1.5 border-2 border-[#06080c] bg-white shadow-[3px_3px_0px_#06080c] transition-all active:translate-x-0.5 active:translate-y-0.5 active:shadow-none font-bold"
          >
        ...
        <div className="bg-white border-2 border-[#06080c] shadow-[6px_6px_0px_#06080c] p-6 sm:p-8">
          ...
          <div className="border-b-2 border-[#06080c] pb-4 mb-6">
            <div className="flex items-center justify-between gap-2 mb-1">
              <span className="font-['Silkscreen',_monospace] text-[10px] uppercase tracking-widest text-[#45474b] bg-[#edeef0] px-2 py-0.5 border border-[#06080c] font-bold">
                SESSION AUTH // 01
              </span>
            ...
            <p className="font-['Space_Mono',_monospace] text-sm text-[#585f69] mt-1">
          ...
          <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              />
              {nameError && (
                <span className="font-['Space_Mono',_monospace] text-xs text-[#ba1a1a] font-bold mt-1">
                  {nameError}
                </span>
              )}
            </div>
            ...
            {generalError && (
              <div className="bg-[#ffdad6] border-2 border-[#ba1a1a] p-3 text-[#93000a] font-['Space_Mono',_monospace] text-xs font-bold shadow-[2px_2px_0px_#ba1a1a]">
                {generalError}
              </div>
            )}
            ...
            <div className="bg-[#f3f4f6] border-2 border-[#06080c] p-3 flex items-start gap-2">
              ...
              <div className="flex-1">
                <p className="font-['Space_Mono',_monospace] text-xs text-[#06080c] leading-tight">
        ...
        {/* Status Bar */}
        <div className="mt-4 flex items-center justify-between text-[#45474b] font-['Space_Mono',_monospace] text-[10px] uppercase px-1 font-bold">
