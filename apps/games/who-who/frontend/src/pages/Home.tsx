      ...
      <div className="flex flex-col items-center justify-center max-w-5xl mx-auto space-y-12">
        ...
        <section className="w-full text-center flex flex-col items-center pt-4">
          <div className="inline-flex items-center gap-2 px-4 py-1 bg-[#edeef0] border-2 border-[#06080c] shadow-[2px_2px_0px_#06080c] mb-6">
            ...
            <span className="font-['Space_Mono',_monospace] text-[10px] uppercase tracking-widest text-[#06080c] font-bold">
              Party Mode Ready
            </span>
          </div>
          ...
          <p className="font-['Space_Mono',_monospace] text-base text-[#45474b] max-w-xl mx-auto tracking-normal">
          ...
          <div className="flex flex-col justify-between bg-white border-2 border-[#06080c] p-8 shadow-[4px_4px_0px_#06080c] transition-transform duration-100 hover:-translate-y-0.5 hover:-translate-x-0.5 hover:shadow-[6px_6px_0px_#06080c]">
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="font-['Space_Mono',_monospace] text-[10px] uppercase bg-[#edeef0] px-2 py-0.5 border border-[#06080c] text-[#06080c] font-bold">
                  PLAYER PORTAL
                </span>
              </div>
              ...
              <p className="font-['Space_Mono',_monospace] text-sm text-[#45474b] mb-8 leading-relaxed">
        ...
        <section className="w-full bg-white border-2 border-[#06080c] p-8 shadow-[4px_4px_0px_#06080c]">
          <div className="border-b-2 border-[#06080c] pb-4 mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div>
              <span className="font-['Space_Mono',_monospace] text-[10px] uppercase tracking-widest text-[#585f69] font-bold block mb-1">
                EXECUTION SEQUENCE
              </span>
            ...
            <span className="font-['Space_Mono',_monospace] text-xs text-[#06080c] font-bold bg-[#edeef0] border border-[#06080c] px-3 py-1 self-start sm:self-auto">
              3-STEP PROTOCOL
            </span>
          </div>
        ...
        <section className="w-full bg-[#dce3ef] border-2 border-[#06080c] p-6 shadow-[4px_4px_0px_#06080c] flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="font-['Space_Mono',_monospace] text-xs text-[#5e656f] mt-0.5">
              Use Who Who for ice breakers, family gatherings, corporate
              meetups, and party nights.
            </p>
          </div>
          <div className="shrink-0 self-end sm:self-center">
            <span className="font-['Space_Mono',_monospace] text-[10px] font-bold tracking-widest text-[#06080c] border border-[#06080c] px-3 py-1 bg-white">
              INSTANT DEPLOY
            </span>
          </div>
        </section>
